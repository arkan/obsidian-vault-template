...
- **Regulation / structural blockers** — legal, technical, distribution constraints specific to the geography (often France/EU for the user).
...
- **Surprises** : ce que la recherche a révélé que the user n'avait pas anticipé
