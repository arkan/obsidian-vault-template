...
- Script: `.Codex/skills/github-import/gh_stars.py`
...
# Full sync
python3 gh_stars.py --all

# Custom count
python3 gh_stars.py --count 50

# Fix dates only (no new imports)
python3 gh_stars.py --fix-dates

# Strip Details/Topics sections from all files
python3 gh_stars.py --strip-sections
```
...
```
| YYYY-MM-DD HH:MM | ingest | github-import | X créées, Y maj | Resources/GitHub-Stars/ |
```
